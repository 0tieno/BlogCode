...
/**
 * Centralized exception-to-HTTP-response translator for student-service.
 * See course-service's {@code GlobalExceptionHandler} for the detailed
...
public class GlobalExceptionHandler {
     ...
     * {@code 404 Not Found}.
     *
     * @param ex      the exception thrown when a student is missing
